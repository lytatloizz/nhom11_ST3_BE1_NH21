<?php include "header.php";?>
  ...
  <div class="content-wrapper">
    ...
    <form action="upload_file_edit_manu.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <?php $id = $_GET['id']; $getManuById = $manufacture->getManuById($id); foreach($getManuById as $value): ?>
              <div class="form-group">
                <label for="inputDescription">Protype Name</label>
                <input type="text" id="inputName" class="form-control" value="<?php echo $value['manu_name'] ?>" name="name">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
