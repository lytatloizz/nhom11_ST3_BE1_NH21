          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <?php $getAllid = $products->getAllProducts(); foreach($getAllid as $value): ?>
              ...
              <div class="form-group">
                ...
                <?php $id = $_POST['id']; $getProductById = $products->getProductById($id); foreach($getProductById as $value): ?>
                <input type="text" id="inputName" class="form-control" value="<?php echo $value['name'] ?>">
                <?php endforeach ?>
              </div>
              <div class="form-group">
